            ...
            <div className="mx-auto max-w-7xl px-6 py-16 space-y-12">
                <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
                    <div className="space-y-4">
                        <Link to="/" className="inline-block text-primary hover:text-primary/90">
                            <Logo />
                        </Link>
                        <p className="text-muted-foreground max-w-xs">
                            Modern ride-sharing platform for riders, drivers, and admins — built with trust and transparency.
                        </p>
                    ...
                    <div>
                        ...
                        <ul className="mt-4 space-y-2 text-sm">
                            <li><Link to="/login" className="hover:text-primary transition">Ride Booking</Link></li>
                            <li><Link to="/register" className="hover:text-primary transition">Driver Registration</Link></li>
                        </ul>
                    </div>
                ...
                <p className="text-center text-xs text-muted-foreground">
                    &copy; {new Date().getFullYear()}. Ride Smarter. All rights reserved.
                </p>
            </div>
        </footer>
    )
